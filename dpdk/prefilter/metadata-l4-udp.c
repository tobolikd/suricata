...
int MetadataDecodePacketUDP(metadata_to_suri_t *metadata_to_suri,
        metadata_to_suri_help_t *metadata_to_suri_help, uint16_t len)
{
    ...
    metadata_to_suri->metadata_udp.src_port =
            rte_be_to_cpu_16(metadata_to_suri_help->udp_hdr->src_port);
    metadata_to_suri->metadata_udp.dst_port =
            rte_be_to_cpu_16(metadata_to_suri_help->udp_hdr->dst_port);
