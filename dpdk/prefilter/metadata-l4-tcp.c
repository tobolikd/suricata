                ...
                case TCP_OPT_WS:
                    if (olen != TCP_OPT_WS_LEN) {
                        ...
                        if (metadata_to_suri->metadata_tcp.tcpVars.ws.type != 0) {
                            ...
                            SET_OPTS(metadata_to_suri->metadata_tcp.tcpVars.ws,
                ...
                case TCP_OPT_SACKOK:
                    if (olen != TCP_OPT_SACKOK_LEN) {
                        ...
                        if (metadata_to_suri->metadata_tcp.tcpVars.sackok.type != 0) {
                            ...
                            SET_OPTS(metadata_to_suri->metadata_tcp.tcpVars.sackok,
                                    tcp_opts[tcp_opt_cnt]);
                        }
                    }
                    break;
                ...
                case TCP_OPT_SACK:
                    ...
                    if ((olen != 2) &&
                        ...
                        if (metadata_to_suri->metadata_tcp.tcpVars.sack.type != 0) {
                            ...
                            SET_OPTS(metadata_to_suri->metadata_tcp.tcpVars.sack,
                                    tcp_opts[tcp_opt_cnt]);
                        }
                    }
                    break;
                case TCP_OPT_TFO:
                    ...
                    if ((olen != 2) && (olen < TCP_OPT_TFO_MIN_LEN || olen > TCP_OPT_TFO_MAX_LEN ||
                        ...
                        if (metadata_to_suri->metadata_tcp.tcpVars.tfo.type != 0) {
                            ...
                            SET_OPTS(metadata_to_suri->metadata_tcp.tcpVars.tfo,
                                    tcp_opts[tcp_opt_cnt]);
                        }
                    }
                    break;
                    ...
                    if (olen == 4 || olen == 12) {
                        ...
                        if (magic == 0xf989) {
                            if (metadata_to_suri->metadata_tcp.tcpVars.tfo.type != 0) {
                                ...
                                SET_OPTS(metadata_to_suri->metadata_tcp.tcpVars.tfo,
                                        tcp_opts[tcp_opt_cnt]);
                                metadata_to_suri->metadata_tcp.tcpVars.tfo.type =
